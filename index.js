...
const swaggerOptions = {
  swaggerDefinition: {
    info: {
      title: "Corona Open API Brebes & Tegal",
      description: "Information About Corona API in Brebes & Tegal",
      contact: {
...
app.get("/tegal", async function (req, res) {
  ...
  if (token !== "RGlSdW1haEFqYVNheWFuZw==") {
    ...
    try {
      ...
      $(
        "body > section > div > div > div > div.inner > div > div.widget-user-header > center > h5 > strong"
      ).each((index, element) => {
        let text = $(element)
          .text()
          .replace(" (Pelaku Perjalanan)", "")
          .replace(" (Orang Tanpa Gejala)", "")
          .replace(" (Orang Dalam Pantauan)", "")
          .replace(" (Pasien Dalam Pengawasan)", "");
        title.push(text);
      });
      $(
        "body > section > div > div > div > div.inner > div > div.widget-user-header > center > h4 > strong"
      ).each((index, element) => {
      ...
      $(
        "body > section > div > div > div > div.inner > div > div.card-footer > div > div.col-sm-6.border-right > div > span"
      ).each((index, element) => {
      ...
      $(
        "body > section > div > div > div > div.inner > div > div.card-footer > div > div > div > span"
      ).each((index, element) => {
        let text = $(element).text();
      ...
      $(
        "body > section > div > div.col-md-4 > div > div.panel-body > table > thead > tr"
      ).each((index, element) => {
        if (index === 0) {
      ...
      $(
        "body > section > div > div.col-md-4 > div > div.panel-body > table > tbody > tr"
      ).each((index, element) => {
      ...
      $(
        "body > section > div:nth-child(2) > div.col-md-3 > div > div.panel-body > div"
      ).each((index, element) => {
...
app.get("/Opentegal", async function (req, res) {
  res.header("Access-Control-Allow-Origin", "*");
  res.header("Access-Control-Allow-Headers", "X-Requested-With");
